...
public class WebLogAspect {
     ...
     * 1 定义切入点
     */
    @Pointcut("execution(* com.advgm.controller.*.*(..))") // controller 包里面所有类，类里面的所有方法 都有该切面
    public void webLog(){}
    ...
    public Object recodeWebLog(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
       ...
       // 执行方法的真实调用
        ...
        webLog.setMethod(targetClassName+"."+method.getName()); // com.advgm.controller.UserController.login()
